...
class CartController extends Controller
{
    ...
    public function storeAddress(Request $request)
    {
        ...
        $address->is_default = $request->isdefault ?? false;
        $address->save();

        return redirect()->route('cart.address')->with('success', 'Address added successfully!');
    }
    ...
    public function updateAddress(Request $request, $id)
    {
        ...
        return redirect()->route('cart.address')->with('success', 'Address updated successfully!');
    }
    ...
    public function deleteAddress($id)
    {
        ...
        $address->delete();
        return redirect()->route('cart.address')->with('success', 'Address deleted successfully!');
    }
