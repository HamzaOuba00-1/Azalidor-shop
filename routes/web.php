...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/account-details', [UserController::class, 'edit'])->name('account.details');
    Route::post('/account-details/update', [UserController::class, 'update'])->name('account.update');

    Route::get('/account-address', [CartController::class, 'showAddress'])->name('cart.address');
    Route::get('/account-address/create', [CartController::class, 'createAddress'])->name('cart.address.create');
    Route::post('/account-address/store', [CartController::class, 'storeAddress'])->name('cart.address.store');
    Route::get('/account-address/{id}/edit', [CartController::class, 'editAddress'])->name('cart.address.edit');
    Route::put('/account-address/{id}/update', [CartController::class, 'updateAddress'])->name('cart.address.update');
    Route::delete('/account-address/{id}/delete', [CartController::class, 'deleteAddress'])->name('cart.address.delete');
