                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            ...
                                            Improve Your Sleep<br /><strong>for Less!</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Get better rest without breaking the bank—shop exclusive deals on top-quality sleep essentials today!</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/shop_banner2.png" width="630"
                                            height="450" alt=" accessories"
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            Your Living Room with<br /><strong>azalidor</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Discover stylish and comfortable furniture to transform your space effortlessly!</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/shop_banner1.png" width="630"
                                            height="450" alt=" accessories"
                                            class="slideshow-bg__img object-fit-cover" />
                                    </div>
                                </div>
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            Style, Comfort & Elegance<br /><strong>Only with azalidor</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Upgrade your living room effortlessly!</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
