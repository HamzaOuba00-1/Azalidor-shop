            ...
            <div class="checkout-form">
                <div class="billing-info__wrapper">
                    ...
                    @if($addresses->count() > 0)
                                    ...
                                    @foreach($addresses as $address)
                                        <div class="my-account__address-list-item">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="selected_address" id="address-{{ $address->id }}" value="{{ $address->id }}" {{ $address->is_default ? 'checked' : '' }}>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <a href="{{ route('cart.address.create') }}" class="btn btn-sm btn-info">Add New Address</a>
                            </div>
                        </div>
                    @else
                        <!-- Afficher le formulaire de saisie d'adresse si aucune adresse n'existe -->
                        <div class="row mt-5">
                            <div class="col-md-6">
